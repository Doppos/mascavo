class Contact < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :address_infos, :reject_if => :all_blank, :allow_destroy => true
  accepts_nested_attributes_for :online_infos, :reject_if => :all_blank, :allow_destroy => true
  accepts_nested_attributes_for :document_infos, :reject_if => :all_blank, :allow_destroy => true
