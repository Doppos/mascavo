...
ActiveRecord::Schema.define(:version => 20121227193743) do
  ...
  create_table "professional_infos", :force => true do |t|
  ...
  add_index "professional_infos", ["company_id"], :name => "index_professional_infos_on_company_id"
